...
/* ============================================================
   SECTION 04 — BEST WORK / PRODUCT LINE METRO
   ...
   - PRODUCT LINE branding (yellow line identity kept).
   ============================================================ */
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1200px] px-5 py-24 sm:px-8 sm:py-32 lg:px-12">
        ...
        <motion.p
          className="mt-6 max-w-3xl font-mono text-xs uppercase tracking-[0.3em] text-[#6B6B6B] sm:text-sm"
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-10% 0px" }}
      ...
      {showPinned ? (
        <div ref={outerRef} className="relative w-full">
          ...
          >
            {/* Yellow horizontal PRODUCT LINE through the middle */}
            <div
              aria-hidden
            ...
            <div className="absolute left-0 right-0 top-0 z-20 flex items-center justify-between gap-4 border-b border-white/10 bg-[#0A0A0A]/80 px-5 py-3 backdrop-blur-sm sm:px-8">
              <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.25em]">
                ...
                <span className="text-[#FFD400]">{"● PRODUCT LINE"}</span>
                <span className="text-[#6B6B6B]">/</span>
              ...
              {showKeyHint && inView && showPinned && !openStationId && (
                ...
                >
                  <div className="flex flex-col items-center gap-4 rounded-lg border border-[#FFD400]/40 bg-[#0A0A0A]/90 px-8 py-6 backdrop-blur-md">
                    ...
                    <p className="text-center font-mono text-[10px] uppercase tracking-[0.2em] text-[#6B6B6B]">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start gap-5">
        ...
        {/* Platform signboard — PRODUCT LINE label, hindi name, platform no. */}
      ...
      >
        ...
        <div className="px-6 py-8 sm:px-8 sm:py-10">
          ...
          <button
            ...
            onClick={onClose}
            onMouseEnter={() => play("tick")}
            className="mb-6 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.25em] text-[#6B6B6B] transition-colors hover:text-[#FFD400] focus-ring"
            aria-label="Return to Product Line"
            data-cursor-label="back"
          >
            <span aria-hidden className="text-[#FFD400]">←</span>
            <span>{"// RETURN TO PRODUCT LINE"}</span>
          </button>
