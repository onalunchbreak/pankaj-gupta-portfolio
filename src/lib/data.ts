...
export const METRO_STATIONS: MetroStation[] = [
  ...
  },
  {
    ...
    problem:
      "Flying senior instructors out to remote factories to train technicians on multi-million dollar machinery was slow, expensive, and risky — mistakes on live equipment weren't cheap. Remote training efficiency sat around 3%.",
